/*
  # Fix currency code data type casting

  1. Changes
    - Cast currency code from char(4) to text explicitly
    - Keep existing function parameters and return types
...
BEGIN
  ...
  WITH transactions AS (
    SELECT 
      t.currency_id,
      c.code::text as currency_code, -- Explicitly cast code to text
